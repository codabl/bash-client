...
# Setup prompt
#
RUN echo 'export PS1="[Brainrex API Explorer] \$ "' >> ~/.bashrc
RUN echo 'export PROMPT="[Brainrex API Explorer] \$ "' >> ~/.zshrc
...
line REST client for $(tput setaf 6)Brainrex API Explorer$(tput sgr0).\n\
\n\
